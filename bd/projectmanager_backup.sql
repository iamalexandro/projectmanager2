...
INSERT INTO `curso` VALUES (1,'1150605','Analisis y diseno de sistemas','A'),(2,'1150606','Seminario de investigacion II','A'),(3,'11500704','Teoria General de las Comunicaciones','A'),(4,'1150809','Formulacion y evaluacion de proyectos','A'),(5,'1150705','Ingenieria de software','A'),(6,'1150804','Redes de computadores','A'),(7,'1150604','Sistemas operativos','A'),(9,'1150817','Gestion de bases de datos','A');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Tabla que guarda los datos de los docentes_cursos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `curso_docente` VALUES (1,1,1,2017,1),(2,3,4,2017,1),(3,9,5,2017,2);
...
CREATE TABLE `curso_estudiante` (
  ...
  CONSTRAINT `curso_estudiante_curso_fk` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`) ON UPDATE CASCADE,
  CONSTRAINT `curso_estudiante_estudiante_fk` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiante` (`id_estudiante`) ON UPDATE CASCADE
...
INSERT INTO `curso_estudiante` VALUES (1,5,12,2017,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='Tabla que guarda los datos de los docentes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `docente` VALUES (1,'Carlos Tapias','carlosalexistr@ufps.edu.co','3213332323','$2y$10$zaCoEo5hK9flHRYpswC8TeY.yuGYSBIo/37ZMBps.rxPQPb9h6l7u'),(4,'Brayam Mora','brayamalbertoma@ufps.edu.co','3213342362','$2y$10$/2yQIoPCDbMf4cB6p.wR3OlNM824ycMTj2Qkvdu0IUxNWSFvGShAK'),(5,'Julian Olarte','fredyjulianot@ufps.edu.co','5755656','$2y$10$m5WWiMfoMDIxotM8sZ/6uucnGYoSYn/1.1VYyIikhla8XPNVd14Q2'),(15,'Martin Calixto','mcalixto@ufps.edu.co','3155432213','$2y$10$MKF4IBF3rQVWKSFFxzwAZu4KVeceo8bCYFiOO2sdirQJ1hrAM3ake'),(16,'Pilar Rodriguez','judithdelpilart@ufps.edu.co','32111123232','$2y$10$XEhgrr4s/d1YbtmCqXg3H.oIWlPXCLbaoYNcDF7FrewZj0cKhgyou'),(18,'Janeth Parada','janethpc@ufps.edu.co','3213214323','$2y$10$tfykqp2WChaMVnHCvq4nFeM/NI83x2t7lCeizzhs5iPMaTgBnqU0q');
...
CREATE TABLE `estudiante` (
  ...
  UNIQUE KEY `correo` (`correo`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='Tabla que guarda los datos de los estudiantes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `estudiante` VALUES (12,'Cristiano Ronaldo','cristianor@ufps.edu.co','777776','$2y$10$Llasxzy79dv3ZNPGiKmyQ.lIf0XtkOfF7WKYtgUkwC8xoWBG9IZIO',1151010),(13,'julian olarte','julian21olarte@gmail.com','4363563635','$2y$10$ph6Hhp0kr23np15zpf/.p.2T.MX7NNlUu/eAVOraElC5s8IQzKMC6',1150981);
...
--
-- Table structure for table `recuperarpass`
--

DROP TABLE IF EXISTS `recuperarpass`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `recuperarpass`
--

LOCK TABLES `recuperarpass` WRITE;
...
-- Dump completed on 2017-11-29  1:21:13
