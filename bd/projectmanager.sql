...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2017 a las 18:57:57
...
INSERT INTO `curso` (`id_curso`, `codigo`, `nombre`, `grupo`) VALUES
(1, '1150605', 'Analisis y diseno de sistemas', 'A'),
(2, '1150606', 'Seminario de investigacion II', 'A'),
(3, '11500704', 'Teoria General de las Comunicaciones', 'A'),
(4, '1150809', 'Formulacion y evaluacion de proyectos', 'A'),
(5, '1150705', 'Ingenieria de software', 'A'),
(6, '1150804', 'Redes de computadores', 'A'),
(7, '1150604', 'Sistemas operativos', 'A'),
(9, '1150817', 'Gestion de bases de datos', 'A');
...
INSERT INTO `curso_estudiante` (`id_curso_estudiante`, `id_curso`, `id_estudiante`, `anio`, `periodo`) VALUES
(1, 5, 12, 2017, 2);
...
(1, 'Carlos Tapias', 'carlosalexistr@ufps.edu.co', '3213332323', '$2y$10$zaCoEo5hK9flHRYpswC8TeY.yuGYSBIo/37ZMBps.rxPQPb9h6l7u'),
...
(18, 'Janeth Parada', 'janethpc@ufps.edu.co', '3213214323', '$2y$10$tfykqp2WChaMVnHCvq4nFeM/NI83x2t7lCeizzhs5iPMaTgBnqU0q');
...
(6, 5, 9, 'Proyecto del profesor julian', '', '', '', '2017-11-27', NULL, 'En desarrollo', ''),
(8, 4, 3, 'Proyecto del profesor brayam', '', '', '', '2017-11-27', '2017-11-27', 'finalizado', 'C:xampphtdocsprojectmanager2controlador/../archivos/');
...
--
ALTER TABLE `curso_docente`
  MODIFY `id_curso_docente` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `curso_estudiante`
--
ALTER TABLE `curso_estudiante`
  MODIFY `id_curso_estudiante` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `docente`
--
ALTER TABLE `docente`
  MODIFY `id_docente` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `proyecto`
  MODIFY `id_proyecto` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `proyecto_estudiante`
--
ALTER TABLE `proyecto_estudiante`
  MODIFY `id_proyecto_estudiante` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `curso_estudiante`
  ADD CONSTRAINT `curso_estudiante_curso_fk` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`) ON UPDATE CASCADE,
  ADD CONSTRAINT `curso_estudiante_estudiante_fk` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiante` (`id_estudiante`) ON UPDATE CASCADE;
